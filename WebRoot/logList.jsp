				...
				<tbody>
					<s:iterator value="logs" status="st">
						<tr>
							...
							<td>
								<span title='<s:property value="operParams"/>'><s:property value="@com.lx.survey.util.StringUtil@getDescString(operParams)"/></span>
							</td>
							<td>
								<span title='<s:property value="operResult"/>'><s:property value="@com.lx.survey.util.StringUtil@getDescString(operResult)"/></span>
							</td>
							<td>
								<span title='<s:property value="resultMsg"/>'><s:property value="@com.lx.survey.util.StringUtil@getDescString(resultMsg)"/></span>
							</td>
							<td>
