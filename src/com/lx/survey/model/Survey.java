...
public class Survey extends BaseEntity{
	...
	private static final long serialVersionUID = 2668888249874394656L;
	private Integer id;
	...
	//建立Survey 到 User 之间 多对一关联关系
	private User user;
	
	//建立从Survey 到 Page 之间 一对多关联关系
	private Set<Page> pages = new HashSet<Page>();

	private boolean closed; //是否关闭 默认 打开
	
	private String logoPhotoPath; //logo 图片路径
	//最小最大叶序
